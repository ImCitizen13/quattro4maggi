...
import { Skia, useFont } from "@shopify/react-native-skia";import { LinearGradient } from "expo-linear-gradient";
...
export default function MorphingMetalView() {
  const [metal, setMetal] = useState<MetalPresetName>("chrome");

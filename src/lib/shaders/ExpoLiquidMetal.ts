...
export const expoLiquidMetalShader = `
...
half4 main(float2 fragCoord) {
  ...
  // Use Perlin noise instead of simplex
...
// Default rainbow colors for iridescence (classic spectrum)
export const DEFAULT_IRID_COLORS = {
  iIridColor0: [1, 0, 0] as const, // Red      (0°)
  iIridColor1: [1, 1, 0] as const, // Yellow   (60°)
  iIridColor2: [0, 1, 0] as const, // Green    (120°)
  iIridColor3: [0, 1, 1] as const, // Cyan     (180°)
  iIridColor4: [0, 0, 1] as const, // Blue     (240°)
  iIridColor5: [1, 0, 1] as const, // Magenta  (300°)
};
